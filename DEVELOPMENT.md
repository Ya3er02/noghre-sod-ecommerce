...
```bash
git remote add encore encore://noghre-sod-ecommerce-8e3i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/noghre-sod-ecommerce-8e3i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/noghre-sod-ecommerce-8e3i/settings/integrations/github)
