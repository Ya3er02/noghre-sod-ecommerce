...
export function ProductFilter({
  ...
  return (
    <>
      ...
      {/* Desktop Filter Panel - Always rendered, controlled by CSS */}
      <div className={`hidden lg:block lg:sticky top-0 ${className}`}>
        <FilterContent />
      </div>

      {/* Mobile Filter Panel - Animated Drawer */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
            initial={{ x: '100%' }}
            ...
            className="fixed top-0 right-0 h-screen w-80 bg-white z-50 overflow-y-auto shadow-2xl lg:hidden"
          >
            <FilterContent />
          </motion.div>
        )}
